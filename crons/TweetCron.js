...
const runSingleCityTweet = cron.schedule('*/23 * * * *', async () => {
...
export const startTweetCron = () => {
    runSingleCityTweet.stop();
    runMultiCitySameCountryTweet.stop();
    runMultiCityMultiCountryTweet.stop();
    runDeleteDailyTweet.stop();
